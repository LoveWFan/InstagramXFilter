...
public class GPUImageWarmFilter extends GPUImageBlendFilter {
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/warm_layer1.jpg");
		        mMaskGrey2TextureId = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/bluevintage_mask1.jpg");
		    }
	    });
	}
}
