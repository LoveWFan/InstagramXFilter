...
public class GPUImageValenciaFilter extends GPUImageBlendFilter {
	private int[] inputTextureHandles = {-1,-1};
	private int[] inputTextureUniformLocations = {-1,-1};
	private int mGLStrengthLocation;

	public GPUImageValenciaFilter(){
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/valenciamap.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/valenciagradientmap.png");
		    }
	    });
	}
}
