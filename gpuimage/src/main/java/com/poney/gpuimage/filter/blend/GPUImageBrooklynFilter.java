...
public class GPUImageBrooklynFilter extends GPUImageBlendFilter {
	private int[] inputTextureHandles = {-1,-1,-1};
	private int[] inputTextureUniformLocations = {-1,-1,-1};
    private int mGLStrengthLocation;

	public GPUImageBrooklynFilter(){
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/brooklynCurves1.png");
				inputTextureHandles[1] = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/filter_map_first.png");
				inputTextureHandles[2] = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/brooklynCurves2.png");
		    }
	    });
	}
}
