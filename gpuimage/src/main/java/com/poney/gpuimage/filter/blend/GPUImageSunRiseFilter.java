 ...
 * 日出滤镜
 */
public class GPUImageSunRiseFilter extends GPUImageBlendFilter {
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                ...
                mMaskGrey1TextureId = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/amaro_mask1.jpg", OpenGlUtils.NO_TEXTURE);
                GLES20.glActiveTexture(GLES20.GL_TEXTURE5);
                mMaskGrey2TextureId = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/amaro_mask2.jpg", OpenGlUtils.NO_TEXTURE);
                GLES20.glActiveTexture(GLES20.GL_TEXTURE6);
                mMaskGrey3TextureId = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/toy_mask1.jpg", OpenGlUtils.NO_TEXTURE);
            }
        });
    }
