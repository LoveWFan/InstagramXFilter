...
public class GPUImageAmaroFilter extends GPUImageBlendFilter {
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                inputTextureHandles[0] = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/brannan_blowout.png");
                inputTextureHandles[1] = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/overlaymap.png");
                inputTextureHandles[2] = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/amaromap.png");
            }
        });
    }
}
