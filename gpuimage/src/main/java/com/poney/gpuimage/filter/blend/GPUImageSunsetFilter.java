...
public class GPUImageSunsetFilter extends GPUImageBlendFilter {
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/rise_mask1.jpg");
		        mMaskGrey2TextureId = OpenGlUtils.loadTexture(GPUImageParams.sContext, "filter/rise_mask2.jpg");
		    }
	    });
	}
}
